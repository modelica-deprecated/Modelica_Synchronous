...
<a href=\"Modelica_Synchronous.ClockSignals.Sampler.ShiftSample\">Modelica_Synchronous.ClockSignals.Sampler.ShiftSample</a>.
   ...
   signals to derive new event driven clocks."
        ...
        Modelica_Synchronous.ClockSignals.Clocks.Rotational.RotationalClock rotational_clock_2
          annotation (Placement(transformation(extent = {{-20,-50},{0,-30}})));

        Modelica_Synchronous.ClockSignals.Clocks.Logical.ConjunctiveClock
          conjunctiveClock
          annotation (Placement(transformation(extent = {{40,20},{60,40}})));
        Modelica_Synchronous.ClockSignals.Clocks.Logical.DisjunctiveClock
          disjunctiveClock
